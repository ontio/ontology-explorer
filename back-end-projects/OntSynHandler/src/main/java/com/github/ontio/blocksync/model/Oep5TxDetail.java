...
public class Oep5TxDetail extends Oep5TxDetailKey implements Serializable {
    ...
    public Oep5TxDetail withTxType(Integer txType) {
    ...
    public Oep5TxDetail withTxTime(Integer txTime) {
    ...
    public Oep5TxDetail withBlockHeight(Integer blockHeight) {
    ...
    public Oep5TxDetail withAmount(BigDecimal amount) {
    ...
    public Oep5TxDetail withFee(BigDecimal fee) {
        this.setFee(fee);
        return this;
    }
    ...
    public Oep5TxDetail withAssetName(String assetName) {
    ...
    public Oep5TxDetail withFromAddress(String fromAddress) {
    ...
    public Oep5TxDetail withToAddress(String toAddress) {
    ...
    public Oep5TxDetail withDescription(String description) {
    ...
    public Oep5TxDetail withBlockIndex(Integer blockIndex) {
    ...
    public Oep5TxDetail withConfirmFlag(Integer confirmFlag) {
    ...
    public Oep5TxDetail withEventType(Integer eventType) {
    ...
    public Oep5TxDetail withContractHash(String contractHash) {
    ...
    public Oep5TxDetail withPayer(String payer) {
        this.setPayer(payer);
        return this;
    }
    ...
    public Oep5TxDetail withCalledContractHash(String calledContractHash) {
