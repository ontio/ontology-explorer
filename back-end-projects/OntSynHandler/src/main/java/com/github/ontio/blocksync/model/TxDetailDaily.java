...
public class TxDetailDaily extends TxDetailDailyKey implements Serializable {
    ...
    public TxDetailDaily withTxType(Integer txType) {
    ...
    public TxDetailDaily withTxTime(Integer txTime) {
    ...
    public TxDetailDaily withBlockHeight(Integer blockHeight) {
    ...
    public TxDetailDaily withAmount(BigDecimal amount) {
    ...
    public TxDetailDaily withFee(BigDecimal fee) {
        this.setFee(fee);
        return this;
    }
    ...
    public TxDetailDaily withAssetName(String assetName) {
    ...
    public TxDetailDaily withFromAddress(String fromAddress) {
    ...
    public TxDetailDaily withToAddress(String toAddress) {
    ...
    public TxDetailDaily withDescription(String description) {
    ...
    public TxDetailDaily withBlockIndex(Integer blockIndex) {
    ...
    public TxDetailDaily withConfirmFlag(Integer confirmFlag) {
    ...
    public TxDetailDaily withEventType(Integer eventType) {
    ...
    public TxDetailDaily withContractHash(String contractHash) {
    ...
    public TxDetailDaily withPayer(String payer) {
        this.setPayer(payer);
        return this;
    }
    ...
    public TxDetailDaily withCalledContractHash(String calledContractHash) {
