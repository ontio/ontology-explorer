...
public class ContractController {
    ...
    public ResponseBean queryContractTxsByPage(@PathVariable("contract_type") @Pattern(regexp = "oep4|OEP4|oep5|OEP5|oep8|OEP8|orc20|ORC20|other|OTHER", message = "Incorrect contract type") String contractType,
