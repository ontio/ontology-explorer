...
@Table(name = "tbl_erc20_tx_detail")
public class Erc20TxDetail {
    /**
     * 交易hash
     */
    @Id
...
//    block_index as blockIndex,
    ...
    public Erc20TxDetail() {
    }
//    fee as fee

    @Builder
    public Erc20TxDetail(String txHash, Integer txType, Integer txTime, Integer blockHeight, Integer confirmFlag,Integer blockIndex, BigDecimal fee) {
        this.txHash = txHash;
        this.txType = txType;
        this.txTime = txTime;
        this.blockHeight = blockHeight;
