...
//    block_index as blockIndex,
    ...
    public Orc20TxDetail() {
    }
//    fee as fee

    @Builder
    public Orc20TxDetail(String txHash, Integer txType, Integer txTime, Integer blockHeight, Integer confirmFlag, Integer blockIndex, BigDecimal fee) {
        this.txHash = txHash;
        this.txType = txType;
        this.txTime = txTime;
        this.blockHeight = blockHeight;
