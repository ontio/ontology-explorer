...
CREATE TABLE `tbl_node_inspire` (
  ...
  `node_release_inspire_rate` varchar(10) NOT NULL COMMENT '节点释放ONG激励收益率',
  `user_release_inspire` bigint(20) NOT NULL COMMENT '用户释放ONG激励',
  `user_release_inspire_rate` varchar(10) NOT NULL COMMENT '用户释放ONG激励收益率',
  `node_commission_inspire` bigint(20) NOT NULL COMMENT '节点手续费激励',
  `node_commission_inspire_rate` varchar(10) NOT NULL COMMENT '节点手续费激励收益率',
  `user_commission_inspire` bigint(20) NOT NULL COMMENT '用户手续费激励',
  `user_commission_inspire_rate` varchar(10) NOT NULL COMMENT '用户手续费激励收益率',
  `node_foundation_inspire` bigint(20) NOT NULL COMMENT '节点基金会激励',
  `node_foundation_inspire_rate` varchar(10) NOT NULL COMMENT '节点基金会激励收益率',
  `user_foundation_inspire` bigint(20) NOT NULL COMMENT '用户基金会激励',
  `user_foundation_inspire_rate` varchar(10) NOT NULL COMMENT '用户基金会激励收益率',
