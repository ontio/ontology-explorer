...
CREATE TABLE tbl_address_daily_aggregation (
    ...
    token_contract_hash    CHAR(40)       NOT NULL COMMENT 'Token合约hash',
    date_id                INT            NOT NULL COMMENT '日期维度ID',
    balance                DECIMAL(40, 9) NOT NULL DEFAULT 0 COMMENT '日终余额',
    usd_price              DECIMAL(40, 9) NOT NULL DEFAULT 0 COMMENT '当天USD价格',
    max_balance            DECIMAL(40, 9) NOT NULL DEFAULT 0 COMMENT '最高余额',
    min_balance            DECIMAL(40, 9) NOT NULL DEFAULT 0 COMMENT '最低余额',
    deposit_tx_count       INT            NOT NULL DEFAULT 0 COMMENT '入金交易数量',
    withdraw_tx_count      INT            NOT NULL DEFAULT 0 COMMENT '出金交易数量',
    deposit_amount         DECIMAL(40, 9) NOT NULL DEFAULT 0 COMMENT '入金金额',
    withdraw_amount        DECIMAL(40, 9) NOT NULL DEFAULT 0 COMMENT '出金金额',
