...
CREATE TABLE `tbl_contract` (
    ...
    `ont_sum`         DECIMAL(40, 20) NOT NULL COMMENT '该合约的总的ont流通量',
    `ong_sum`         DECIMAL(40, 20) NOT NULL COMMENT '该合约的总的ong流通量',
    ...
    `total_reward`    DECIMAL(40, 20) NOT NULL DEFAULT '0.000000000' COMMENT '总激励',
    `lastweek_reward` DECIMAL(40, 20) NOT NULL DEFAULT '0.000000000' COMMENT '上周激励',
